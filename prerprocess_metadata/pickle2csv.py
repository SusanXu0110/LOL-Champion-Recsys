...
def process_data(file_path, summoner_ids, champion_ids, win_values):
...
file_path1 = 'data/LOL_rank/match_data_version1.pickle'
process_data(file_path1, summoner_ids, champion_ids, win_values)

# If needed, process the second pickle file
# file_path2 = 'data/LOL_rank/match_data_version2.pickle'
# process_data(file_path2, summoner_ids, champion_ids, win_values)
...
# Create lists to store win rates and play rates for each summoner-champion pair
win_rate_list = []
play_rate_list = []

# Populate win rate and play rate lists
...
output_file_path = 'data/LOL_rank/summoner_champion_stats_for_pickle1.csv'
